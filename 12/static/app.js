...
function makeForm (array_01, form_id) {
    ...
    var i_quiz_datatime = document.createElement("input");
    i_quiz_datatime.type = "text";
    i_quiz_datatime.value = start_of_quiz.toISOString() ;
    i_quiz_datatime.name = "quiz_datatime";
    ui_form_01.appendChild(i_quiz_datatime);


    var i_quiz_duration = document.createElement("input");
    i_quiz_duration.type = "text";
